...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}bakend/images/brand/favicon.ico" />

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="{{asset('/')}}bakend/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

    <!-- STYLE CSS -->
    <link href="{{asset('/')}}bakend/css/style.css" rel="stylesheet" />
    <link href="{{asset('/')}}bakend/css/skin-modes.css" rel="stylesheet" />



    <!--- FONT-ICONS CSS -->
    <link href="{{asset('/')}}bakend/plugins/icons/icons.css" rel="stylesheet" />

    <!-- INTERNAL Switcher css -->
    <link href="{{asset('/')}}bakend/switcher/css/switcher.css" rel="stylesheet">
    <link href="{{asset('/')}}bakend/switcher/demo.css" rel="stylesheet">
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="mt-1">
                                        <a class="bg-img bg-img1" href="javascript:void(0);"><img
                                                src="{{asset('/')}}bakend/images/media/bg-img1.jpg" alt="Bg-Image" id="bgimage1"></a>
                                        <a class="bg-img bg-img2" href="javascript:void(0);"><img
                                                src="{{asset('/')}}bakend/images/media/bg-img2.jpg" alt="Bg-Image" id="bgimage2"></a>
                                        <a class="bg-img bg-img3" href="javascript:void(0);"><img
                                                src="{{asset('/')}}bakend/images/media/bg-img3.jpg" alt="Bg-Image" id="bgimage3"></a>
                                        <a class="bg-img bg-img4" href="javascript:void(0);"><img
                                                src="{{asset('/')}}bakend/images/media/bg-img4.jpg" alt="Bg-Image" id="bgimage4"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="page">
    <div>
        ...
        <div class="col col-login mx-auto text-center">
            <a href="index.html">
                <img src="{{asset('/')}}bakend/images/brand/logo.png" class="header-brand-img" alt="">
            </a>
        </div>
            ...
            <div class="wrap-login100 p-0">
                <div class="card-body">
                    <form class="login100-form validate-form" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Password is required">
                            <input class="input100" type="password" name="password_confirmation" placeholder="Confirmed Password">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
											<i class="zmdi zmdi-lock" aria-hidden="true"></i>
										</span>

    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{route('dashboard')}}">
                <img src="{{asset('/')}}bakend/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{asset('/')}}bakend/images/brand/logo-1.png" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{asset('/')}}bakend/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
                <img src="{{asset('/')}}bakend/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('blog.manage')}}" class="slide-item">Manage Blog</a></li
                    </ul>
                </li>
